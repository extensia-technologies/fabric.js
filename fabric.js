/* build: `node build.js modules=ALL exclude=serialization,parser,image_filters,easing,node,freedrawing,gestures,animation,json no-svg-export minifier=uglifyjs` */
